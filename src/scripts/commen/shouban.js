	...
	require(["jquery","public"], function($){
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                var k=data.related[0].attr.length-1;
                $('.blk_detail_main_spec .pord-color label').html(data.related[0].attr[k].sAttrName);
                str='<li class="current" attrid="112"><div class="pord-selbox">'+data.related[0].attr[k].sAttrValue+'</div></li>'
                for(var i=1; i<data.related.length; i++){
                    str+='<li attrid="112"><div class="pord-selbox">'+data.related[i].attr[k].sAttrValue+'</div></li>'
                }
                    ...
                    <div class="popup-main">
                        ...
                        <div class="popup-con">
                            ...
                            <div class="popup-btnbox">
                                <a class="fl popup-btn btn-sure mr20" href="buycar.html">确认</a>
        ...
        function addToloca(){
            ...
            var obj={
                ...
                "src" :$('.picdetail-list .active img').attr('src'),
